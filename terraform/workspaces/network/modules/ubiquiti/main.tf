...
resource "unifi_device" "switches" {
  ...
  dynamic "port_override" {
    ...
    content {
      ...
      port_profile_id = lookup(data.unifi_port_profile.port_profile, port_override.value.port_profile_name, null) != null ? data.unifi_port_profile.port_profile[port_override.value.port_profile_name].id : data.unifi_port_profile.default.id
    }
  }
}
